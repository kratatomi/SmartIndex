...
if __name__ == "__main__":
    ...
    class JSONifiedState(EventScannerState):
        ...
        def reset(self):
            ...
            self.state = {
                "last_scanned_block": 1469466, #Block where the contract was deployed
                "blocks": {},
            }
    ...
    def run():
        ...
        SIDX = web3.eth.contract(abi=abi)
        ...
        scanner = EventScanner(
            ...
            contract=SIDX,
            state=state,
            events=[SIDX.events.Transfer],
            filters={"address": SIDX_ADDRESS},
